...
public class ExprPlayerChatPrefix extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(
                ExprPlayerChatPrefix.class,
                String.class,
                ExpressionType.PROPERTY,
                "%player%'s [custom] chat prefix",
                "[the] [custom] chat prefix of %player%"
        );
    }
    ...
    protected String[] get(Event event) {
        ...
        String name = SERIALIZER.serialize(provider.getCustomChatPrefix(p));
    ...
    public void change(Event event, Object[] delta, ChangeMode mode) {
        ...
        provider.setCustomChatPrefix(p, componentName);
