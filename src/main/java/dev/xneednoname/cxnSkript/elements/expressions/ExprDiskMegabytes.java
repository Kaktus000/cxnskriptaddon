...
public class ExprDiskMegabytes extends SimpleExpression<Long> {

    static {
        Skript.registerExpression(
                ExprDiskMegabytes.class,
                Long.class,
    ...
    protected Long @Nullable [] get(Event event) {
        ...
        try {
            ...
            return new Long[] { limits.diskMegabytes() };
        } catch (Exception e) {
            Skript.warning("Failed to get realm disk megabytes: " + e.getMessage());
            return null;
        }
    }
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "the realm's disk megabytes";
    }
}