...
public class ExprPlayerChatSuffix extends SimpleExpression<String> {
    ...
    static {
        Skript.registerExpression(
                ExprPlayerChatSuffix.class,
                String.class,
                ExpressionType.PROPERTY,
                "%player%'s [custom] chat suffix",
                "[the] [custom] chat suffix of %player%"
        );
    }
    ...
    protected String[] get(Event event) {
        ...
        String name = SERIALIZER.serialize(provider.getChatSuffix(p));
    ...
    public void change(Event event, Object[] delta, ChangeMode mode) {
        ...
        provider.setChatSuffix(p, componentName);
