...
public class ExprMaxLoadedWorldsCount extends SimpleExpression<Integer> {

    static {
        Skript.registerExpression(
                ExprMaxLoadedWorldsCount.class,
                Integer.class,
    ...
    protected Integer @Nullable [] get(Event event) {
        ...
        try {
            ...
            return new Integer[] { limits.loadedWorldsCount() };
        } catch (Exception e) {
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "the realm's max loaded world count";
    }
}