...
public class ExprMaxCustomGroupsCount extends SimpleExpression<Integer> {

    static {
        Skript.registerExpression(
                ExprMaxCustomGroupsCount.class,
                Integer.class,
    ...
    protected Integer @Nullable [] get(Event event) {
        ...
        try {
            ...
            return new Integer[] { limits.customGroupsCount() };
        } catch (Exception e) {
    ...
    public String toString(@Nullable Event event, boolean debug) {
        return "the realm's max custom group count";
    }
}