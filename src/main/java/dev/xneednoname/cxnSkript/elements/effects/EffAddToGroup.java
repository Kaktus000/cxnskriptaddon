...
public class EffAddToGroup extends Effect {

    static {
        Skript.registerEffect(EffAddToGroup.class, "add %player% to %group%");
    }
    ...
    protected void execute(Event event) {
        ...
        for (Player user : player.getAll(event)) {
            ...
            if (provider == null) {
                ...
                provider.addPlayerToGroup(p.getUniqueId(),g.uniqueId());
            }
